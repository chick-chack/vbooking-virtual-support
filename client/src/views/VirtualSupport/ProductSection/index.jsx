...
export default function ProductSection({
  ...
  return (
    <div className="support-product-section">
      <div className="back clickable" onClick={() => setProductSelected(null)}>
        <LeftArrowSVG width={16} height={16} color="#2D2D2D" />
              ...
              <>
                <Row>
                  <Typography.Text className="fz-18 fw-500">
                    Select{" "}
                    {att.lang.find((lang) => lang.lang === "en")?.attributeName}
                  </Typography.Text>
                </Row>
                          ...
                          <Tooltip title={option.enOptionName}>
                            <button
                              style={{
                                ...
                                outline:
                                  attributes.find((attr) => attr.id === att.id)
